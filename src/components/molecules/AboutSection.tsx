      ...
      <div className="flex flex-col md:flex-row gap-10 px-4">
        <div className="flex flex-col gap-16 md:gap-4 p-4  mb-40 md:mb-0">
          <div className="flex flex-col items-center gap-10 relative">
            ...
            <FadeUp>
              <p className="text-[32px] font-bold gaegu-font text-[#474747]">
                Yours Truly
              </p>
            </FadeUp>
          ...
          <div className="flex flex-col gap-4 items-center">
            ...
            <div className="flex  gap-4 ">
              <TiltIn>
                ...
                >
                  <p className="text-center text-lg font-bold text-[#474747] gaegu-font">
                    Dev Speaker at Peerlist Meetup{" "}
                  </p>
                </div>
              </TiltIn>
            ...
            <div className="flex  gap-4 ">
              <TiltIn>
                ...
                >
                  <p className="text-center text-lg font-bold text-[#474747] gaegu-font">
                    Built & Migrated React Apps to Vite
                  </p>
                </div>
              </TiltIn>
              ...
              <TiltIn>
                ...
                >
                  <p className="text-center text-lg font-bold text-[#474747] gaegu-font">
                    NeoG Camp Grad Leveling Up in React
                  </p>
                </div>
              </TiltIn>
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    <FadeUp>
                      {" "}
                      <div className="flex gap-4">
                        <p className="text-xl text-[#474747] gaegu-font">
                          {experience.role}
                        </p>
                        <p className="text-xl text-[#8C8FA6] gaegu-font">
                          {experience.duration}
                        </p>
                      </div>
                    </FadeUp>
                    <FadeUp>
                      <h4 className="text-[#8C8FA6] max-w-lg md:max-w-2xl text-center md:text-left gaegu-font">
